  ...
  try {
    const message = await client.messages.create({
      ...
      messages: [
        {
          role: "user",
          content: `Here are the notes to analyze. Apply the qualification bar strictly — only surface opportunities that clear it.\n\n${notes}`,
        },
      ],
    });
